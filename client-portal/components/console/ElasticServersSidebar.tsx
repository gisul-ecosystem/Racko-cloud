...
interface ElasticServersSidebarProps {
  sidebarOpen: boolean;
  onCloseSidebar: () => void;
}

export function ElasticServersSidebar({
  sidebarOpen,
  onCloseSidebar,
}: ElasticServersSidebarProps) {
      ...
      >
        <div className="flex h-full min-w-[15rem] flex-col">
          <div className="border-b border-gray-100 px-5 py-5">
            <p className="text-sm font-semibold text-gray-900">Elastic Server Import</p>
            <p className="mt-0.5 text-xs text-gray-400">External server console</p>
          </div>
