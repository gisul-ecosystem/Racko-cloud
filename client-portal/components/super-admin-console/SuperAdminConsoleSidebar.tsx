...
import { LayoutGrid, MonitorCheck, Cloud, Palette, Server } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/super-admin-console/aws/org-admin', label: 'AWS Services', icon: Server, exact: false },
