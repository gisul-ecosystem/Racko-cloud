      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        ...
        <div className="flex flex-col gap-5 p-6 lg:flex-row lg:items-center lg:justify-between lg:p-8">
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2">
            ...
            <Link href={AWS_ROUTES.createRequest} className={RACKO_BTN_PRIMARY}>
        ...
        <>
          {loading ? (
            ...
            <>
              ...
              {stats.total > 0 ? <CompletionBar rate={completionRate} /> : null}
            </>
          )}
            ...
            <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm lg:col-span-2">
              <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4">
                ...
                {!loading && requests.length > 0 ? (
                  <Link href={AWS_ROUTES.createRequest} className={RACKO_LINK_ACCENT}>
                    New request
                  </Link>
                ) : null}
              </div>
              ...
              {loading ? (
                ...
                <div className="px-6 py-14 text-center">
                  ...
                  <Link href={AWS_ROUTES.createRequest} className={`mt-6 ${RACKO_BTN_PRIMARY}`}>
                    <Plus className="h-4 w-4" />
                    Create Request
                  </Link>
                </div>
            ...
            <div className="space-y-6">
              <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 space-y-2">
                  <Link href={AWS_ROUTES.createRequest} className={`w-full ${RACKO_BTN_PRIMARY}`}>
                    <Plus className="h-4 w-4" />
                    Create Request
                  </Link>
                  <button
