...
import { formatDateTime } from '../../../cloud_automation/utils/formatters';
import type { AwsOrgAdminPrivilegedRoleRequest } from '../../types/orgAdmin';

interface AwsOrgAdminPrivilegedRoleRequestsProps {
...
export function AwsOrgAdminPrivilegedRoleRequests({
  requests,
  loading,
  saving,
  onReview,
}: AwsOrgAdminPrivilegedRoleRequestsProps) {
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-medium text-gray-900">
                    {request.awsRole} · {request.customerEmail}
                  </p>
