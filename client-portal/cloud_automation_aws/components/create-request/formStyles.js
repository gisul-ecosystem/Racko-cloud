...
export const labelClass = 'mb-1.5 block text-xs font-medium uppercase tracking-wide text-gray-500';
...
export const sectionClass = 'rounded-xl border border-gray-200 bg-white p-6 shadow-sm';
