...
export default function GcpUserAccountView({
  user,
  requestId,
  jwtToken,
  portalData,
  ...
  const expiryDate = portalData.endDate
    ...
    : '—';
  const isIdentityCenter = portalData.accessType === 'cloud_identity';
  ...
  return (
    <div className="mx-auto max-w-2xl overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
      <div className="border-b border-gray-100 px-6 py-4">
        ...
        <p className="mt-0.5 text-xs text-gray-500">Your provisioned Gcp lab account status</p>
      </div>
      ...
      <div className="space-y-5 p-6">
        ...
        <div>
          <dt className="mb-2 text-xs font-medium uppercase tracking-wide text-gray-500">Gcp Console</dt>
          {isIdentityCenter ? (
