...
import { generateAwsConsoleUrl } from '../../../../cloud_automation_aws/api/managePortalClient';
...
export default function LaunchConsoleButton({
  ...
  async function handleLaunch(event) {
    ...
    try {
      const result = await generateAwsConsoleUrl(requestId, userIndex, jwtToken);
    ...
    <button
      ...
      title={
        servicePeriodBlocked
          ...
          : 'Open AWS Console for this user'
      }
    >
      {loading ? (
