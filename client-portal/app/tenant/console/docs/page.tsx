  ...
  return (
    <div className="mx-auto max-w-screen-lg space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">Guides and reference for enabled services</p>
      </div>
      <div className="grid gap-6 md:grid-cols-2">
        {sections.map((section) => {
          ...
          return (
            ...
            >
              <div className={`mb-3 inline-flex h-10 w-10 items-center justify-center rounded-lg ${section.color}`}>
