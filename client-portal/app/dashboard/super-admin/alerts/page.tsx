...
import { Bell, RefreshCw, CheckCircle, AlertTriangle, XCircle, History } from 'lucide-react';
...
export default function AlertsPage() {
  ...
  useEffect(() => {
    void loadActive();
    // Poll active alerts every 30s — super admin needs to see new alerts without manual refresh
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 text-sm text-gray-600 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition"
          >
