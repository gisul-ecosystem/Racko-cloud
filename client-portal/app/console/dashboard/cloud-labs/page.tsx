...
export default function TenantCloudLabsHubPage() {
  return (
      ...
      <div className="mx-auto max-w-screen-lg space-y-8">
        <section>
          <div className="mb-2 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Cloud Labs</h1>
              <p className="text-sm text-gray-500">
                Hands-on lab environments — Azure Labs first, more clouds next.
              </p>
            </div>
          </div>
        </section>
