...
function ProjectDrillDown({
  ...
  useEffect(() => {
    ...
    setLoading(true);
    setError(null);
    fetchTenantServiceCostReport(row.projectId)
      .then(setRows)
      .catch((err) =>
...
export default function TenantProjectReportsPage() {
    ...
    <div className="mx-auto max-w-screen-xl space-y-6 pb-10">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Debits from your main tenant wallet, grouped by project or service.
        </p>
      </div>
              ...
              <table className="min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody className="divide-y divide-gray-100">
                  {byProject.length === 0 ? (
                    ...
                    byProject.map((row) => (
                      <tr key={row.projectId || 'unassigned'} className="hover:bg-gray-50/60">
