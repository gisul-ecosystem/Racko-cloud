...
export default function TenantBulkImportPage() {
  ...
  const handleSubmit = async () => {
    ...
    setSubmitting(true);
    try {
      const created = await bulkCreateTenantExternalVMs(vms);
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="block w-full text-sm text-gray-600 file:mr-3 file:rounded-lg file:border-0 file:bg-[var(--cloud-accent-soft)] file:px-4 file:py-2 file:text-sm file:font-medium file:text-[var(--cloud-accent)] hover:file:opacity-90"
            />
          </div>
          <div>
