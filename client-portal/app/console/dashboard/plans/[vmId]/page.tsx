      ...
      {actionError && !showConfirm && (
        <div className="rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800">
          ...
          {actionError.includes('balance') ? (
            <Link href="/console/dashboard/admin/billing" className="ml-1 font-semibold underline">
              Go to Wallet
            </Link>
          ) : null}
        </div>
              ...
              <div className="mt-4 space-y-3 text-sm text-gray-600">
                ...
                {insufficientForQuote && (
                  <p className="rounded-lg border border-orange-200 bg-orange-50 px-3 py-2 text-orange-800">
                    ...
                    <Link href="/console/dashboard/admin/billing" className="font-semibold underline">
                      Add funds
                    </Link>
                  </p>
                )}
