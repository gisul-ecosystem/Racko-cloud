...
import { getMyAdminWalletTransactions } from '@/lib/adminBillingApi';
import type { AdminWalletTransaction } from '@/types/adminBilling';
import {
  fetchProject,
  ...
  const load = useCallback(async () => {
    ...
    try {
      const [p, result] = await Promise.all([
        ...
        getMyAdminWalletTransactions(page, PAGE_SIZE, {
          projectId,
        ...
        <div className="mt-3 flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <div className="mt-1 flex flex-wrap items-center gap-2">
              ...
              {serviceKey ? (
                <Link
                  href={`/console/projects/${projectId}/transactions`}
                ...
                <tr key={tx.id} className="hover:bg-gray-50/60">
                  ...
                  <td className="px-5 py-3 text-right">
                    <Link
                      href={
                        serviceKey
                          ? `/console/projects/${projectId}/transactions/${tx.id}?serviceKey=${encodeURIComponent(serviceKey)}`
                          : `/console/projects/${projectId}/transactions/${tx.id}`
                      }
