const STORAGE_PREFIX = 'racko.gcpManagePortal.';
...
export function saveGcpManagePortalSession(session) {
...
export function loadGcpManagePortalSession() {
...
export function clearGcpManagePortalSession() {
  if (typeof window === 'undefined') return;
