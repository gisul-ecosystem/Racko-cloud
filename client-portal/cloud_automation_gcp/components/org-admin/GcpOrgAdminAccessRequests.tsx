...
import type { GcpOrgAdminAccessRequest } from '../../types/orgAdmin';
...
export function GcpOrgAdminAccessRequests({ requests, loading, saving, onReview }: Props) {
    ...
    <section className="overflow-hidden rounded-xl border border-amber-200 bg-amber-50/50">
      <header className="flex items-center gap-2 border-b border-amber-100 px-5 py-3">
        ...
        <h2 className="text-sm font-semibold text-amber-900">
          Pending Gcp access requests ({requests.length})
        </h2>
      </header>
