...
interface GcpOrgAdminUserUsageModalProps {
  user: GcpOrgAdminUser;
  request: GcpOrgAdminRequestDetail;
  fetchMonitoring: () => Promise<GcpOrgAdminMonitoringResponse | null>;
  onClose: () => void;
}
...
export function GcpOrgAdminUserUsageModal({
  user,
  request,
  fetchMonitoring,
  onClose,
}: GcpOrgAdminUserUsageModalProps) {
  const [loading, setLoading] = useState(true);
  const [monitoring, setMonitoring] = useState<GcpOrgAdminMonitoringResponse | null>(null);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div
        ...
        role="dialog"
        aria-labelledby="Gcp-user-usage-title"
      >
        <div className="flex items-start justify-between border-b border-gray-100 px-5 py-4">
          <div>
            <h3 id="Gcp-user-usage-title" className="text-base font-semibold text-gray-900">
              Usage sessions
            </h3>
