...
import type { GcpOrgAdminUserCost } from '../../types/orgAdmin';

interface GcpOrgAdminCostModalProps {
  userIndex: number;
  cost: GcpOrgAdminUserCost;
  onClose: () => void;
}

export function GcpOrgAdminCostModal({ userIndex, cost, onClose }: GcpOrgAdminCostModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-md rounded-xl border border-gray-200 bg-white shadow-xl">
        <div className="flex items-start justify-between border-b border-gray-100 px-5 py-4">
          <div>
            <h3 className="text-base font-semibold text-gray-900">Gcp Cost Breakdown</h3>
