...
import { GcpCostingModeBadge } from './GcpCostingModeBadge';
import { GcpLabStatusBadge } from './GcpLabStatusBadge';
import { GcpOrgAdminRequestDetailPanel } from './GcpOrgAdminRequestDetailPanel';
import { GcpOrgAdminStatCard } from './GcpOrgAdminStatCard';
import { GcpOrgAdminAccessRequests } from './GcpOrgAdminAccessRequests';
import { GcpOrgAdminPrivilegedRoleRequests } from './GcpOrgAdminPrivilegedRoleRequests';
  ...
  return (
    <div className="mx-auto max-w-screen-2xl space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Gcp Lab Management</h1>
          <p className="mt-1 text-sm text-gray-500">
            Manage provisioned Gcp lab requests and user access
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        />
        <GcpOrgAdminStatCard label="Total Users" value={stats.totalUsers} color="purple" icon="👥" />
      </div>

      <GcpOrgAdminAccessRequests
      ...
      <GcpOrgAdminPrivilegedRoleRequests
              ...
              <div key={request.requestId}>
                ...
                >
                  ...
                  <div className="flex flex-1 flex-wrap items-center gap-2">
                    ...
                    <GcpCostingModeBadge mode={request.costingMode} />
                  ...
                  <div className="ml-auto flex min-w-[160px] flex-col items-end gap-1.5">
                    <GcpLabStatusBadge status={request.status} />
