...
interface GcpOrgAdminBudgetTabProps {
  detail: GcpOrgAdminRequestDetail;
  saving: boolean;
  onRenewBudget: (userIndex: number, topUpAmount: number) => Promise<boolean>;
}

export function GcpOrgAdminBudgetTab({ detail, saving, onRenewBudget }: GcpOrgAdminBudgetTabProps) {
    ...
    <div className="space-y-4 px-2 py-2">
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">
          Monitor Gcp spend per user. Budget is enforced via Cost Explorer polling.
