...
import type { GcpOrgAdminPrivilegedRoleRequest } from '../../types/orgAdmin';

interface GcpOrgAdminPrivilegedRoleRequestsProps {
...
export function GcpOrgAdminPrivilegedRoleRequests({
  requests,
  loading,
  saving,
  onReview,
}: GcpOrgAdminPrivilegedRoleRequestsProps) {
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-medium text-gray-900">
                    {request.gcpRole} · {request.customerEmail}
                  </p>
